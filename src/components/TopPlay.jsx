...
const TopChartCard = ({song,i, isPlaying, activeSong, handlePauseClick, handlePlayClick}) => (
  <div className="w-full flex flex-row items-center hover:bg-[#9f9da4] py-2 p-4 rounded-lg cursor-pointer mb-2">
...
const TopPlay = () => {
  ...
  useEffect(()=>{
    divRef.current.scrollIntoView({behavious : 'smooth'});
  });
    ...
    <div ref={divRef} className='xl:ml-6 ml-0 xl:mb-0 mb-6 flex-1 xl:max-w-[500px] max-w-full flex flex-col'>
      <div className="w-full flex flex-col">
        <div className="flex flex-row justify-between items-center">
          ...
          <Link to='/top-charts'>
            <p className="text-black text-xl font-bold cursor-pointer">See more</p>
          </Link>
        </div>
